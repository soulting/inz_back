...
class GenerativeAiInferenceClient(object):
    ...
    def apply_guardrails(self, apply_guardrails_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/apply_guardrails.py.html>`__ to see an example of how to use apply_guardrails API.
        """
    ...
    def chat(self, chat_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/chat.py.html>`__ to see an example of how to use chat API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def embed_text(self, embed_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/embed_text.py.html>`__ to see an example of how to use embed_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def generate_text(self, generate_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/generate_text.py.html>`__ to see an example of how to use generate_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def rerank_text(self, rerank_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/rerank_text.py.html>`__ to see an example of how to use rerank_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def summarize_text(self, summarize_text_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/generativeaiinference/summarize_text.py.html>`__ to see an example of how to use summarize_text API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
