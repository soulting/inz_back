...
class ApiGatewayClient(object):
    ...
    def add_api_lock(self, api_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/add_api_lock.py.html>`__ to see an example of how to use add_api_lock API.
        """
    ...
    def add_certificate_lock(self, certificate_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/add_certificate_lock.py.html>`__ to see an example of how to use add_certificate_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def add_sdk_lock(self, sdk_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/add_sdk_lock.py.html>`__ to see an example of how to use add_sdk_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_api_compartment(self, api_id, change_api_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/change_api_compartment.py.html>`__ to see an example of how to use change_api_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def change_certificate_compartment(self, certificate_id, change_certificate_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/change_certificate_compartment.py.html>`__ to see an example of how to use change_certificate_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
    ...
    def create_api(self, create_api_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/create_api.py.html>`__ to see an example of how to use create_api API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/apis"
    ...
    def create_certificate(self, create_certificate_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/create_certificate.py.html>`__ to see an example of how to use create_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_sdk(self, create_sdk_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/create_sdk.py.html>`__ to see an example of how to use create_sdk API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/sdks"
    ...
    def delete_api(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/delete_api.py.html>`__ to see an example of how to use delete_api API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def delete_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/delete_certificate.py.html>`__ to see an example of how to use delete_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
    ...
    def delete_sdk(self, sdk_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/delete_sdk.py.html>`__ to see an example of how to use delete_sdk API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sdkId']
    ...
    def get_api(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_api.py.html>`__ to see an example of how to use get_api API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
        resource_path = "/apis/{apiId}"
    ...
    def get_api_content(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_api_content.py.html>`__ to see an example of how to use get_api_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def get_api_deployment_specification(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_api_deployment_specification.py.html>`__ to see an example of how to use get_api_deployment_specification API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def get_api_validations(self, api_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_api_validations.py.html>`__ to see an example of how to use get_api_validations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def get_certificate(self, certificate_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_certificate.py.html>`__ to see an example of how to use get_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
        resource_path = "/certificates/{certificateId}"
    ...
    def get_sdk(self, sdk_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_sdk.py.html>`__ to see an example of how to use get_sdk API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sdkId']
        resource_path = "/sdks/{sdkId}"
    ...
    def list_apis(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/list_apis.py.html>`__ to see an example of how to use list_apis API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_certificates(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/list_certificates.py.html>`__ to see an example of how to use list_certificates API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/certificates"
    ...
    def list_sdk_language_types(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/list_sdk_language_types.py.html>`__ to see an example of how to use list_sdk_language_types API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def list_sdks(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/list_sdks.py.html>`__ to see an example of how to use list_sdks API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/sdks"
    ...
    def remove_api_lock(self, api_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/remove_api_lock.py.html>`__ to see an example of how to use remove_api_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
    ...
    def remove_certificate_lock(self, certificate_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/remove_certificate_lock.py.html>`__ to see an example of how to use remove_certificate_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
    ...
    def remove_sdk_lock(self, sdk_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/remove_sdk_lock.py.html>`__ to see an example of how to use remove_sdk_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sdkId']
    ...
    def update_api(self, api_id, update_api_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/update_api.py.html>`__ to see an example of how to use update_api API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['apiId']
        resource_path = "/apis/{apiId}"
    ...
    def update_certificate(self, certificate_id, update_certificate_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/update_certificate.py.html>`__ to see an example of how to use update_certificate API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['certificateId']
        resource_path = "/certificates/{certificateId}"
    ...
    def update_sdk(self, sdk_id, update_sdk_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/update_sdk.py.html>`__ to see an example of how to use update_sdk API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['sdkId']
        resource_path = "/sdks/{sdkId}"
