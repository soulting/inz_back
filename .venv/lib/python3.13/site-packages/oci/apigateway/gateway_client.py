...
class GatewayClient(object):
    ...
    def add_gateway_lock(self, gateway_id, add_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/add_gateway_lock.py.html>`__ to see an example of how to use add_gateway_lock API.
        """
    ...
    def change_gateway_compartment(self, gateway_id, change_gateway_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/change_gateway_compartment.py.html>`__ to see an example of how to use change_gateway_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
    ...
    def create_gateway(self, create_gateway_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/create_gateway.py.html>`__ to see an example of how to use create_gateway API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_gateway(self, gateway_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/delete_gateway.py.html>`__ to see an example of how to use delete_gateway API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
    ...
    def get_gateway(self, gateway_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/get_gateway.py.html>`__ to see an example of how to use get_gateway API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
        resource_path = "/gateways/{gatewayId}"
    ...
    def list_gateways(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/list_gateways.py.html>`__ to see an example of how to use list_gateways API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def remove_gateway_lock(self, gateway_id, remove_resource_lock_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/remove_gateway_lock.py.html>`__ to see an example of how to use remove_gateway_lock API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
    ...
    def update_gateway(self, gateway_id, update_gateway_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apigateway/update_gateway.py.html>`__ to see an example of how to use update_gateway API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['gatewayId']
        resource_path = "/gateways/{gatewayId}"
