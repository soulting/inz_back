...
class ShardedDatabaseServiceClient(object):
    ...
    def change_private_endpoint_compartment(self, change_private_endpoint_compartment_details, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/change_private_endpoint_compartment.py.html>`__ to see an example of how to use change_private_endpoint_compartment API.
        """
    ...
    def change_sharded_database_compartment(self, change_sharded_database_compartment_details, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/change_sharded_database_compartment.py.html>`__ to see an example of how to use change_sharded_database_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def configure_sharded_database_gsms(self, configure_sharded_database_gsms_details, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/configure_sharded_database_gsms.py.html>`__ to see an example of how to use configure_sharded_database_gsms API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def configure_sharding(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/configure_sharding.py.html>`__ to see an example of how to use configure_sharding API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def create_private_endpoint(self, create_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/create_private_endpoint.py.html>`__ to see an example of how to use create_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_sharded_database(self, create_sharded_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/create_sharded_database.py.html>`__ to see an example of how to use create_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def delete_private_endpoint(self, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/delete_private_endpoint.py.html>`__ to see an example of how to use delete_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privateEndpointId']
    ...
    def delete_sharded_database(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/delete_sharded_database.py.html>`__ to see an example of how to use delete_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def download_gsm_certificate_signing_request(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/download_gsm_certificate_signing_request.py.html>`__ to see an example of how to use download_gsm_certificate_signing_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def fetch_connection_string(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/fetch_connection_string.py.html>`__ to see an example of how to use fetch_connection_string API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def fetch_shardable_cloud_autonomous_vm_clusters(self, fetch_shardable_cloud_autonomous_vm_clusters_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/fetch_shardable_cloud_autonomous_vm_clusters.py.html>`__ to see an example of how to use fetch_shardable_cloud_autonomous_vm_clusters API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def generate_gsm_certificate_signing_request(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/generate_gsm_certificate_signing_request.py.html>`__ to see an example of how to use generate_gsm_certificate_signing_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def generate_wallet(self, sharded_database_id, generate_wallet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/generate_wallet.py.html>`__ to see an example of how to use generate_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def get_private_endpoint(self, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/get_private_endpoint.py.html>`__ to see an example of how to use get_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privateEndpointId']
        resource_path = "/privateEndpoints/{privateEndpointId}"
    ...
    def get_sharded_database(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/get_sharded_database.py.html>`__ to see an example of how to use get_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
        resource_path = "/shardedDatabases/{shardedDatabaseId}"
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_private_endpoints(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/list_private_endpoints.py.html>`__ to see an example of how to use list_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def list_sharded_databases(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/list_sharded_databases.py.html>`__ to see an example of how to use list_sharded_databases API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/shardedDatabases"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def patch_sharded_database(self, sharded_database_id, patch_sharded_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/patch_sharded_database.py.html>`__ to see an example of how to use patch_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
        resource_path = "/shardedDatabases/{shardedDatabaseId}"
    ...
    def prevalidate_sharded_database(self, compartment_id, prevalidate_sharded_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/prevalidate_sharded_database.py.html>`__ to see an example of how to use prevalidate_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def reinstate_proxy_instance(self, private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/reinstate_proxy_instance.py.html>`__ to see an example of how to use reinstate_proxy_instance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privateEndpointId']
    ...
    def start_sharded_database(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/start_sharded_database.py.html>`__ to see an example of how to use start_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def stop_sharded_database(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/stop_sharded_database.py.html>`__ to see an example of how to use stop_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def update_private_endpoint(self, private_endpoint_id, update_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/update_private_endpoint.py.html>`__ to see an example of how to use update_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['privateEndpointId']
        resource_path = "/privateEndpoints/{privateEndpointId}"
    ...
    def update_sharded_database(self, sharded_database_id, update_sharded_database_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/update_sharded_database.py.html>`__ to see an example of how to use update_sharded_database API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
        resource_path = "/shardedDatabases/{shardedDatabaseId}"
    ...
    def upload_signed_certificate_and_generate_wallet(self, sharded_database_id, upload_signed_certificate_and_generate_wallet_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/upload_signed_certificate_and_generate_wallet.py.html>`__ to see an example of how to use upload_signed_certificate_and_generate_wallet API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
    ...
    def validate_network(self, sharded_database_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/globallydistributeddatabase/validate_network.py.html>`__ to see an example of how to use validate_network API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['shardedDatabaseId']
