...
class TraceClient(object):
    ...
    def get_aggregated_snapshot(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apmtraces/get_aggregated_snapshot.py.html>`__ to see an example of how to use get_aggregated_snapshot API.
        """
    ...
    def get_log(self, apm_domain_id, log_key, time_log_started_greater_than_or_equal_to, time_log_ended_less_than, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apmtraces/get_log.py.html>`__ to see an example of how to use get_log API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_span(self, apm_domain_id, span_key, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apmtraces/get_span.py.html>`__ to see an example of how to use get_span API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def get_trace(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apmtraces/get_trace.py.html>`__ to see an example of how to use get_trace API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['traceKey', 'apmDomainId']
    ...
    def get_trace_snapshot(self, apm_domain_id, trace_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.159.0/apmtraces/get_trace_snapshot.py.html>`__ to see an example of how to use get_trace_snapshot API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['traceKey', 'apmDomainId']
